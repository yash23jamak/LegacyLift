...
// import { AlertCircle, CheckCircle2, Code2, Database, Layers, Rocket, Shield, Sparkles, TrendingUp, Zap, ArrowRight, Brain, GitBranch, Package, AlertTriangle, Target, Clock, Award } from 'lucide-react';
...
//               <Badge className="px-4 py-2 text-base bg-gradient-to-r from-cyan-500 to-blue-500 text-white border-0 hover:shadow-lg hover:shadow-cyan-500/50 transition-all">
//                 {data.project.language}
//               </Badge>
//               <Badge className="px-4 py-2 text-base bg-gradient-to-r from-pink-500 to-rose-500 text-white border-0 hover:shadow-lg hover:shadow-pink-500/50 transition-all">
//                 {data.project.files} Files
//               </Badge>
//               <Badge className="px-4 py-2 text-base bg-gradient-to-r from-yellow-500 to-amber-500 text-white border-0 hover:shadow-lg hover:shadow-yellow-500/50 transition-all">
...
//           {/* Component Hierarchy - Large Card */}
//           <Card className="md:col-span-2 lg:col-span-2 bg-white/80 backdrop-blur-xl border-2 border-cyan-200 hover:border-cyan-400 transition-all duration-500 hover:shadow-2xl hover:shadow-cyan-500/20 group overflow-hidden">
//             <div className="absolute inset-0 bg-gradient-to-br from-cyan-500/5 to-blue-500/5 opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
//             <CardHeader className="relative">
//               <div className="flex items-center gap-3 mb-2">
//                 <div className="p-3 rounded-2xl bg-gradient-to-br from-cyan-500 to-blue-500 shadow-lg group-hover:scale-110 transition-transform duration-500">
//                   <GitBranch className="w-6 h-6 text-white" />
//                 </div>
//                 <CardTitle className="text-3xl font-black bg-gradient-to-r from-cyan-600 to-blue-600 bg-clip-text text-transparent">
//                   Component Hierarchy
//                 </CardTitle>
//               </div>
...
//                   <Badge key={idx} className="px-3 py-1.5 bg-gradient-to-r from-cyan-100 to-blue-100 text-cyan-700 border-2 border-cyan-300 hover:shadow-md transition-all">
//                     {example}
//                   </Badge>
//                 ))}
//               </div>
...
//           {/* Complexity Score - Circular Progress */}
//           <Card className="bg-white/80 backdrop-blur-xl border-2 border-purple-200 hover:border-purple-400 transition-all duration-500 hover:shadow-2xl hover:shadow-purple-500/20 group">
...
//                     strokeWidth="12"
//                     fill="none"
//                     strokeDasharray={`${(data.analysis.complexity_score / 10) * 553} 553`}
...
//                 <p className="text-sm text-gray-500 mt-1">Low complexity detected</p>
//               </div>
//             </CardContent>
//           </Card>

//           {/* Modularity - Stacked Cards */}
//           <Card className="md:col-span-2 bg-white/80 backdrop-blur-xl border-2 border-pink-200 hover:border-pink-400 transition-all duration-500 hover:shadow-2xl hover:shadow-pink-500/20 group">
//             <CardHeader>
//               <div className="flex items-center gap-3 mb-2">
//                 <div className="p-3 rounded-2xl bg-gradient-to-br from-pink-500 to-rose-500 shadow-lg group-hover:scale-110 transition-transform duration-500">
//                   <Package className="w-6 h-6 text-white" />
//                 </div>
//                 <CardTitle className="text-3xl font-black bg-gradient-to-r from-pink-600 to-rose-600 bg-clip-text text-transparent">
//                   Modularity Analysis
//                 </CardTitle>
//               </div>
//               <CardDescription className="text-base text-gray-600">
...
//                   >
//                     <div className="absolute inset-0 bg-gradient-to-r from-orange-500/10 to-amber-500/10 translate-x-full group-hover/item:translate-x-0 transition-transform duration-500" />
//                     <div className="relative flex items-start gap-3">
//                       <div className="p-2 rounded-xl bg-gradient-to-br from-orange-500 to-amber-500">
//                         <AlertCircle className="w-4 h-4 text-white" />
//                       </div>
//                       <span className="text-gray-700 font-medium flex-1">{issue}</span>
//                     </div>
//                   </div>
//                 ))}
//               </div>
...
//           {/* Outdated Code - Timeline Style */}
//           <Card className="bg-white/80 backdrop-blur-xl border-2 border-yellow-200 hover:border-yellow-400 transition-all duration-500 hover:shadow-2xl hover:shadow-yellow-500/20">
//             <CardHeader>
//               <div className="flex items-center gap-3 mb-2">
//                 <div className="p-3 rounded-2xl bg-gradient-to-br from-yellow-500 to-amber-500 shadow-lg">
//                   <Clock className="w-6 h-6 text-white" />
//                 </div>
//                 <CardTitle className="text-2xl font-black bg-gradient-to-r from-yellow-600 to-amber-600 bg-clip-text text-transparent">
//                   Outdated Code
//                 </CardTitle>
//               </div>
//             </CardHeader>
...
//         {/* Dependencies - Card Carousel */}
//         <div className="space-y-6">
//           <div className="flex items-center justify-between">
//             <h2 className="text-5xl font-black bg-gradient-to-r from-blue-600 to-cyan-600 bg-clip-text text-transparent">
//               Dependencies
//             </h2>
//             <div className="flex gap-3">
//               <Badge className="px-4 py-2 text-lg bg-gradient-to-r from-blue-500 to-cyan-500 text-white border-0 shadow-lg">
//                 {data.dependencies.total} Total
//               </Badge>
//               <Badge className="px-4 py-2 text-lg bg-gradient-to-r from-orange-500 to-amber-500 text-white border-0 shadow-lg">
//                 {data.dependencies.outdated} Outdated
//               </Badge>
//             </div>
//           </div>
...
//                         <Badge className="bg-gray-100 text-gray-700 border-2 border-gray-300">
//                           v{dep.version}
//                         </Badge>
//                         <Badge className={`${
//                           dep.status === 'outdated'
...
//         {/* Migration Roadmap - Modern Timeline */}
//         <div className="space-y-8">
//           <div className="text-center space-y-4">
//             <div className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full bg-gradient-to-r from-emerald-500/10 to-teal-500/10 border-2 border-emerald-500/20">
//               <Rocket className="w-5 h-5 text-emerald-600" />
//               <span className="text-sm font-bold text-emerald-600">Migration Strategy</span>
//             </div>
//             <h2 className="text-6xl font-black bg-gradient-to-r from-emerald-600 to-teal-600 bg-clip-text text-transparent">
//               Your Path to {data.migration.recommended_framework}
//             </h2>
...
//           {/* Benefits & Risks - Split View */}
//           <div className="grid md:grid-cols-2 gap-6">
//             <Card className="bg-gradient-to-br from-emerald-50 to-teal-50 border-2 border-emerald-300 shadow-xl">
//               <CardHeader>
...
//               <Brain className="w-5 h-5 text-cyan-600 animate-pulse" />
//               <span className="text-sm font-bold text-cyan-600">Powered by AI</span>
//             </div>
//             <h2 className="text-6xl font-black bg-gradient-to-r from-cyan-600 to-blue-600 bg-clip-text text-transparent">
//               Analysis Engine
//             </h2>
//           </div>
...
//                     <div className={`w-16 h-16 rounded-2xl bg-gradient-to-br ${tool.gradient} flex items-center justify-center shadow-xl group-hover:scale-110 group-hover:rotate-6 transition-all duration-500`}>
//                       <Icon className="w-8 h-8 text-white" />
//                     </div>
//                     <h3 className="text-xl font-black text-gray-800">{tool.title}</h3>
//                     <p className="text-sm text-gray-600 leading-relaxed">
//                       {'method' in tool.data ? tool.data.method : tool.data.rationale}
//                     </p>
//                     {'findings' in tool.data && tool.data.findings.length > 0 && (
//                       <div className="space-y-2 pt-2">
//                         {tool.data.findings.map((finding: string, fIdx: number) => (
...
//                       </div>
//                     )}
//                     {'patterns_found' in tool.data && tool.data.patterns_found.length > 0 && (
//                       <div className="space-y-2 pt-2">
//                         {tool.data.patterns_found.map((pattern: string, pIdx: number) => (
...
//               Start your migration journey today with our AI-powered analysis and expert guidance
//             </p>
    ...
    <div className="min-h-screen bg-gradient-to-br from-cyan-50 via-blue-50 to-purple-50 overflow-x-hidden">
      ...
      <div className="relative z-10 container mx-auto px-4 py-16 space-y-16">
        ...
        <Card className="bg-white/80 backdrop-blur-xl border-2 border-cyan-200 shadow-2xl">
          <CardHeader>
            <CardTitle className="text-4xl font-black bg-gradient-to-r from-cyan-600 to-blue-600 bg-clip-text text-transparent">
        ...
        <Card className="bg-white/80 backdrop-blur-xl border-2 border-emerald-200 shadow-2xl">
          <CardHeader>
            <div className="flex items-center justify-between">
              <div>
                <CardTitle className="text-4xl font-black bg-gradient-to-r from-emerald-600 to-teal-600 bg-clip-text text-transparent">
                  Migration Strategy
                </CardTitle>
